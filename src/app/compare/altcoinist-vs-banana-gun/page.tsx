...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Banana Gun has a large established community, especially for Ethereum sniping. Altcoinist has 20,000+ traders in groups and is the fastest-growing multi-chain option.",
  },
  {
